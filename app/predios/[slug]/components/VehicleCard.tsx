...
const vehicleCategory = vehiculo.titulo || "";      
  ...
  return (
    <article className="overflow-hidden rounded-3xl bg-white sm:p-4">
      {/* Imagen */}
      <div className="relative aspect-[16/9] w-full overflow-hidden bg-slate-100 sm:rounded-2xl sm:border sm:border-slate-200">
        <div
      ...
      <div className="p-4 sm:px-0 sm:pb-0">
        <div>
          <h3 className="line-clamp-2 text-base font-black uppercase leading-tight tracking-tight text-slate-950">
            {vehicleMainTitle}
          </h3>
